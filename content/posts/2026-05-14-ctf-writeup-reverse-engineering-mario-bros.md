...
*Figure 2: The actual game from win.zip*
...
ELF 64-bit LE pie executable, x-64, dynamically linked, **not stripped**. **Detect It Easy** confirms:

![DIE output](/images/ctf-writeup-reverse-engineering-mario-bros/03-die.png)
*Figure 3: DIE detects ELF64, AMD64, GCC.*
...
*Figure 4: Filtered output from strings.*
